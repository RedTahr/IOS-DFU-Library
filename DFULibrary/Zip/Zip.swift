...
open class Zip {
    ...
    open class func unzipFile(_ zipFilePath: URL, destination: URL, overwrite: Bool, password: String?, progress: ((_ progress: Double) -> ())?) throws {
        ...
        repeat {
            ...
            guard var pathString = String(validatingUTF8: fileName) else {
                throw ZipError.unzipFail
            }
